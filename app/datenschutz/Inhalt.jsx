...
function Inhalt() {
  ...
  return (
    <nav className=' bg-[#121212] '>
      ...
      Web3 EngineerDE hat keinen Einfluss auf Art und Umfang der durch LinkedIn verarbeiteten Daten, die Art der Verarbeitung und Nutzung oder die Weitergabe dieser Daten an Dritte.<br /> Auch hat sie insoweit keine effektiven Kontrollmöglichkeiten.

      Ebenso hat Web3 EngineerDE keine Kenntnis vom Inhalt Ihrer an LinkedIn übermittelten Daten und kann keine Auskünfte darüber geben, welche Daten über Sie durch die Nutzung des Dienstes LinkedIn gespeichert sind. 
      ...
      Sollten Dienste Dritter von LinkedIn für die LinkedIn-Seite von Web3 EngineerDE eingesetzt werden, hat Web3 EngineerDE dies weder in Auftrag gegeben, noch abgesegnet oder sonst in irgendeiner Art unterstützt. Auch werden ihr die bei der Analyse gewonnenen personenbezogenen Daten nicht zur Verfügung gestellt. Lediglich bestimmte, nicht-personenbezogene, aggregierte Informationen über die Aktivität, also etwa die Anzahl der Profil- oder Link-Klicks auf ein bestimmtes Posting oder die Seite, sind für Web3 EngineerDE über ihren Account einsehbar. Überdies hat Web3 EngineerDE keine Möglichkeit, den Einsatz solcher Dienste auf seiner LinkedIn-Seite zu verhindern oder abzustellen.<br />
      ...
      Über in Webseiten eingebundene LinkedIn-Buttons oder -Widgets und die Verwendung von Cookies ist es LinkedIn möglich, Ihre Besuche auf diesen Webseiten zu erfassen und Ihrem LinkedIn-Profil zuzuordnen. Anhand dieser Daten können Inhalte oder Werbung auf Sie zugeschnitten angeboten werden. Dementsprechend verzichtet Web3 EngineerDE auf die Nutzung solcher Buttons und Widgets auf ihren eigenen Webseiten.<br />

      Web3 EngineerDE verzichtet vor dem Hintergrund der datenschutzrechtlichen Probleme auf die Schaltung von Werbeanzeigen auf LinkedIn und somit auf die aktive Nutzung der von LinkedIn gesammelten Daten zur gezielten Steuerung ihrer Kommunikation.
